...
const Banner = () => {
  return (
    <div className="w-full h-[700px] bg-center bg-no-repeat bg-cover bg-banner relative">
      ...
      <div className="w-full h-full flex flex-col md:flex-row items-center justify-center space-y-10 md:space-y-0 md:space-x-[30px] p-4 relative z-20">
        <div className="flex flex-col space-y-4 items-baseline w-full md:w-[50%]">
          <p className="text-white bg-gradient-to-r text-xl from-red-600 to-red-200 py-3 px-5 text-center md:text-left">
            TV Show
          </p>
          ...
          <div className="flex items-center justify-center md:justify-start space-x-3">
            <img src={Icon} alt="rating" className="w-6 h-6 md:w-8 md:h-8" />
            <img src={Icon} alt="rating" className="w-6 h-6 md:w-8 md:h-8" />
            <img src={Icon} alt="rating" className="w-6 h-6 md:w-8 md:h-8" />
            <img src={Icon} alt="rating" className="w-6 h-6 md:w-8 md:h-8" />
            <img
        ...
        <div className="w-full md:w-[50%] flex items-center justify-center">
          <div className="w-[80%] md:w-[350px] h-[250px] md:h-[450px] relative group cursor-pointer">
